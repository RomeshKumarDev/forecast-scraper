...
Return ONLY valid JSON (a list of objects). If fields are unknown, use null.
Try to extract:source_name( name of the website, e.g Accuweather or IMBD whatever is used in title), full_date (e.g., "15-10-2025", "dd-mm-yyyy"), day (e.g., "Monday"), max_temp  , min_temp , condition, humidity, precipitation, wind_speed, wind_direction.
Use concise values, e.g., "31°C", "4%", "NW 10 km/h".
Keep day names in English (e.g., "Fri 24 Oct", not localized forms).
"""
    prompt = ChatPromptTemplate.from_template(user_prompt)
